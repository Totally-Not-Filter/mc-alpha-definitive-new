...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
		...
		if(Keyboard.isKeyDown(Keyboard.KEY_F3)) {
			var8.drawStringWithShadow("MC Alpha Definitive v0.0.1a (" + this.mc.field_6292_I + ")", 2, 2, 16777215);
			...
			var8.drawStringWithShadow("MC Alpha Definitive v0.0.1a", 2, 2, 16777215);
		}
